...
private:
    ...
    virtual void run_history_step_cancelation_job(u64 page_id, u64 operation_id, i32 target_step, Vector<Web::HTML::CrossProcessId>, Web::HTML::UserNavigationInvolvement, Optional<u64> initiation_id, bool check_for_cancelation) override;
    virtual void run_changing_navigable_history_job(u64 page_id, u64 operation_id, Web::HTML::CrossProcessId navigable_id, i32 target_step, Web::HTML::SessionHistoryEntryDescriptor, Web::HTML::UserNavigationInvolvement, Optional<u64> initiation_id) override;
    virtual void apply_changing_navigable_continuation(u64 page_id, u64 operation_id, Web::HTML::CrossProcessId navigable_id, u64 script_history_length, u64 script_history_index, Vector<Web::HTML::SessionHistoryEntryDescriptor>) override;
