...
private:
    ...
    virtual void set_top_level_session_history(u64 page_id, u64 seed_id, Vector<Web::HTML::SessionHistoryEntryDescriptor>, Web::HTML::CommittedSessionHistoryState, size_t current_top_level_entry_index, bool allow_reconstructing_current_entry) override;
