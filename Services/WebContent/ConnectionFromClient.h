...
private:
    ...
    virtual void create_representing_page(Compositing::PageId page_id, Vector<Web::HTML::RemoteNavigableDescriptor> remote_navigables, Optional<Compositing::PageId> browsing_context_group_page_id) override;
