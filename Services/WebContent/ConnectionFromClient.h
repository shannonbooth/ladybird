...
private:
    ...
    virtual void set_top_level_session_history(u64 page_id, Vector<Web::HTML::SessionHistoryEntryDescriptor>, size_t current_top_level_entry_index, bool current_entry_will_be_populated_by_traversal) override;
