...
void PageClient::page_did_update_current_session_history_entry(Web::HTML::SessionHistoryEntryDescriptor const& entry)
{
    client().async_did_update_current_session_history_entry(m_id, entry);
}
