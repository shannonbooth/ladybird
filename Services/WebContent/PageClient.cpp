...
void PageClient::page_did_start_loading(Optional<String> const& navigation_id, URL::URL const& url, Variant<Empty, String, Web::HTML::POSTResource> document_resource, Web::HTML::CrossProcessId document_state_id, bool is_redirect, Web::Bindings::NavigationHistoryBehavior history_handling)
{
    if (m_webdriver)
...
bool PageClient::page_did_request_traverse_the_history_by_delta(Optional<u64> history_traversal_request_id, Web::HTML::SessionHistoryOperationId last_session_history_mutation_id, int delta)
{
    return client().did_request_traverse_the_history_by_delta(m_id, history_traversal_request_id, last_session_history_mutation_id, delta);
}
