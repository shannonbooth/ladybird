...
void PageHost::initialize(u64 initial_page_id, Vector<Web::HTML::RemoteNavigableDescriptor> remote_ancestors, Web::HTML::CrossProcessId root_navigable_id, Web::HTML::CrossProcessIdAllocator cross_process_id_allocator, Web::HTML::SessionHistoryEntryDescriptor initial_history_entry, Web::HTML::VisibilityState system_visibility_state)
{
    ...
    if (remote_ancestors.is_empty())
        ...
        Web::HTML::LocalNavigable::create_local_root(first_page.page(), move(remote_ancestors), initial_history_entry.document_state.id, system_visibility_state);
}
