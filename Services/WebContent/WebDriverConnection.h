...
private:
    ...
    void iconify_the_window(GC::Ref<JS::HeapFunction<void()>>);
    void restore_the_window(GC::Ref<JS::HeapFunction<void()>>);
    void wait_for_visibility_state(GC::Ref<JS::HeapFunction<void()>>, Web::HTML::VisibilityState);

    using OnNavigationComplete = GC::Ref<JS::HeapFunction<void(Web::WebDriver::Response)>>;
    ...
    using GetStartNode = GC::Ref<JS::HeapFunction<ErrorOr<GC::Ref<Web::DOM::ParentNode>, Web::WebDriver::Error>()>>;
    using OnFindComplete = GC::Ref<JS::HeapFunction<void(Web::WebDriver::Response)>>;
