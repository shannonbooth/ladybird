...
public:
    ...
    void initialize(u64 initial_page_id, Vector<Web::HTML::RemoteNavigableDescriptor> remote_ancestors, Web::HTML::CrossProcessId root_navigable_id, Web::HTML::CrossProcessIdAllocator, Web::HTML::SessionHistoryEntryDescriptor initial_history_entry, Web::HTML::VisibilityState system_visibility_state);
