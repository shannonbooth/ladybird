...
private:
    ...
    virtual void page_did_start_loading(Optional<String> const&, URL::URL const&, Variant<Empty, String, Web::HTML::POSTResource>, Web::HTML::CrossProcessId, bool, Web::Bindings::NavigationHistoryBehavior) override;
    ...
    virtual void page_did_update_current_session_history_entry(Web::HTML::SessionHistoryEntryUpdateKind, Web::HTML::SessionHistoryEntryDescriptor const&) override;
    virtual void page_did_apply_top_level_same_document_session_history_navigation(Web::HTML::SameDocumentSessionHistoryNavigation const&) override;
