...
void SVGUseElement::process_the_url(Optional<String> const& href)
{
    ...
    if (is_referrenced_element_from_external_document()) {
...
bool SVGUseElement::is_referrenced_element_from_external_document() const
{
...
{
    if (!m_href.fragment().has_value() || is_referrenced_element_from_external_document()) {
        return;
    }
...
// https://svgwg.org/svg2-draft/linking.html#processingURL-validity
