...
// https://whatpr.org/html/9893/b8ea975...df5706b/webappapis.html#resolve-a-module-specifier
    ...
    OnFetchScriptComplete on_complete)
{
    ...
    VERIFY(module_type_allowed(module_type, module_map_realm));
    ...
    auto process_response_consume_body = [&module_map, url, module_type, &module_map_realm, on_complete](JS::NonnullGCPtr<Fetch::Infrastructure::Response> response, Fetch::Infrastructure::FetchAlgorithms::BodyBytes body_bytes) {
        ...
        // 7. If mimeType is a JavaScript MIME type and moduleType is "javascript", then set moduleScript to the result of creating a JavaScript module script given sourceText, settingsObject's realm, response's URL, and options.
        // FIXME: Pass options.
...
// https://whatpr.org/html/9893/b8ea975...df5706b/webappapis.html#fetch-a-module-script-tree
...
// https://whatpr.org/html/9893/b8ea975...df5706b/webappapis.html#fetch-an-inline-module-script-graph
...
// https://whatpr.org/html/9893/b8ea975...df5706b/webappapis.html#fetch-a-single-imported-module-script
    ...
    OnFetchScriptComplete on_complete)
{
    ...
    if (!module_type_allowed(module_type, module_map_realm)) {
        on_complete->function()(nullptr);
        return;
    }
