...
{
    if (m_client->page_did_request_traverse_the_history_by_delta({}, top_level_traversable()->last_emitted_session_history_mutation_id(), delta, HistoryTraversalPrecheck::Needed))
        return;
