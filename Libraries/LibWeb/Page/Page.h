...
public:
    ...
    // A navigable hosted by another process continues a navigation, and receives a posted message, there. A page
    // whose client does not talk to the UI process never holds one.
    ...
    virtual void page_did_destroy_local_root() { }
