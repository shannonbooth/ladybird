...
public:
    ...
    virtual void page_did_start_loading(Optional<String> const&, URL::URL const&, Variant<Empty, String, HTML::POSTResource> document_resource, HTML::CrossProcessId document_state_id, bool is_redirect, Bindings::NavigationHistoryBehavior history_handling = Bindings::NavigationHistoryBehavior::Auto)
    {
    ...
    virtual void page_did_update_current_session_history_entry([[maybe_unused]] HTML::SessionHistoryEntryUpdateKind update_kind, [[maybe_unused]] HTML::SessionHistoryEntryDescriptor const& entry) { }
    virtual void page_did_apply_top_level_same_document_session_history_navigation([[maybe_unused]] HTML::SameDocumentSessionHistoryNavigation const&) { }
