...
public:
    static WebIDL::ExceptionOr<URLPatternInit> parse(Utf8View const& input);
...
private:
    ...
    WebIDL::ExceptionOr<void> compute_protocol_matches_a_special_scheme_flag();
...
URLPatternInit parse_a_constructor_string(Utf8View const& input);
