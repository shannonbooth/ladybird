...
public:
    ...
    static WebIDL::ExceptionOr<Vector<Token>> tokenize(Utf8View const& input, Policy policy);
...
private:
    ...
    WebIDL::ExceptionOr<void> process_a_tokenizing_error(u32 next_position, u32 value_position);
