...
{
    dbgln_if(CSS_PARSER_DEBUG, "Parsing CSS stylesheet with location: {}", location.has_value() ? location->to_string() : "null"_string);
    ...
    return CSSStyleSheet::create(realm(), rule_list, *media_list, {});
}
