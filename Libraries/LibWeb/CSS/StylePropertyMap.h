...
public:
    ...
    WebIDL::ExceptionOr<void> set(FlyString property, Vector<Variant<GC::Ref<CSSStyleValue>, String>> values);
    WebIDL::ExceptionOr<void> append(FlyString property, Vector<Variant<GC::Ref<CSSStyleValue>, String>> values);
