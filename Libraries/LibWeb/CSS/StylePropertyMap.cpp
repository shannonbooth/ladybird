...
static bool any_have_non_matching_associated_property(FlyString const& property, Vector<Variant<GC::Ref<CSSStyleValue>, String>> values)
{
...
WebIDL::ExceptionOr<void> StylePropertyMap::set(FlyString property_name, Vector<Variant<GC::Ref<CSSStyleValue>, String>> values)
{
...
WebIDL::ExceptionOr<void> StylePropertyMap::append(FlyString property_name, Vector<Variant<GC::Ref<CSSStyleValue>, String>> values)
{
