...
class ServiceWorkerAgent : public JS::Cell {
...
void ServiceWorkerAgent::visit_edges(Visitor& visitor)
{
    Base::visit_edges(visitor);
...
static int obtain_a_service_worker_agent()
{
...
static GC::Ptr<ServiceWorkerGlobalScope> setup_service_worker_global_scope(JS::Realm& realm, ServiceWorkerRecord const& service_worker)
{
    (void)realm;
    (void)service_worker;
