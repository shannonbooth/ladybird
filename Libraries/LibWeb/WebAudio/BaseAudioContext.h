...
public:
    ...
    GC::Ref<WebIDL::Promise> decode_audio_data(GC::Handle<WebIDL::BufferSource>, GC::Ptr<WebIDL::CallbackType>, GC::Ptr<WebIDL::CallbackType>);
...
private:
    void queue_a_decoding_operation(GC::Ref<JS::PromiseCapability>, GC::Handle<WebIDL::BufferSource>, GC::Ptr<WebIDL::CallbackType>, GC::Ptr<WebIDL::CallbackType>);
