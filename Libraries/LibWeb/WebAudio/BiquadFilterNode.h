...
public:
    ...
    WebIDL::ExceptionOr<void> get_frequency_response(GC::Handle<WebIDL::BufferSource> const&, GC::Handle<WebIDL::BufferSource> const&, GC::Handle<WebIDL::BufferSource> const&);
