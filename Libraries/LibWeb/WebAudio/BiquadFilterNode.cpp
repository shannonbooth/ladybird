...
WebIDL::ExceptionOr<void> BiquadFilterNode::get_frequency_response(GC::Handle<WebIDL::BufferSource> const& frequency_hz, GC::Handle<WebIDL::BufferSource> const& mag_response, GC::Handle<WebIDL::BufferSource> const& phase_response)
{
    (void)frequency_hz;
    (void)mag_response;
    (void)phase_response;
