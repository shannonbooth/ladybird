...
void HTMLDetailsElement::update_shadow_tree_slots()
{
    ...
    GC::ConservativeVector<HTMLSlotElement::SlottableHandle> summary_assignment { heap() };
    GC::ConservativeVector<HTMLSlotElement::SlottableHandle> descendants_assignment { heap() };
