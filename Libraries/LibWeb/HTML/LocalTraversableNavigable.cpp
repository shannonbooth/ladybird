...
// A page beginning to host the tab's document: the traversable stands in for its current entry until the document it
// populates activates, as a child's stand-in does in a page hosting an isolated frame.
