...
public:
    ...
    CheckIfUnloadingIsCanceledResult check_if_unloading_is_canceled(Vector<GC::Handle<Navigable>> navigables_that_need_before_unload);
...
private:
    ...
    CheckIfUnloadingIsCanceledResult check_if_unloading_is_canceled(Vector<GC::Handle<Navigable>> navigables_that_need_before_unload, GC::Ptr<TraversableNavigable> traversable, Optional<int> target_step, Optional<UserNavigationInvolvement> user_involvement_for_navigate_events);
