...
// The process-safe form of PreparedNavigation: what step 8 of navigate sends to the process hosting the target
// navigable's document. A navigation given a response never crosses processes, and the source element stays behind.
