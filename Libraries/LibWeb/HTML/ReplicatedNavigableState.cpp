...
ErrorOr<void> encode(Encoder& encoder, Web::HTML::ReplicatedNavigableState const& state)
{
    ...
    TRY(encoder.encode(state.active_browsing_context_is_popup));
    TRY(encoder.encode(state.active_browsing_context_popup_sandboxing_flag_set));
...
ErrorOr<Web::HTML::ReplicatedNavigableState> decode(Decoder& decoder)
{
    return Web::HTML::ReplicatedNavigableState {
        ...
        .active_browsing_context_is_popup = TRY(decoder.decode<bool>()),
        .active_browsing_context_popup_sandboxing_flag_set = TRY(decoder.decode<Web::HTML::SandboxingFlagSet>()),
