...
public:
    ...
    Variant<GC::Handle<WebIDL::CallbackType>, JS::Value> get(String const& name) const;
    Optional<String> get_name(GC::Handle<WebIDL::CallbackType> const& constructor) const;
