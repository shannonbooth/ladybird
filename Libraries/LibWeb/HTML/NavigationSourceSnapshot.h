...
// The source snapshot params of a navigation whose source document lives in another process. A settings object
// snapshot in the given realm stands in for that document's as the fetch client.
