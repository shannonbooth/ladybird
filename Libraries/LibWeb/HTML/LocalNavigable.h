...
// The navigables among these whose documents this process hosts.
WEB_API Vector<GC::Root<LocalNavigable>> local_navigables_among(Vector<GC::Root<Navigable>> const&);
