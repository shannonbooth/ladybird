...
protected:
    ...
    // A stand-in for the navigable another page hosts: initialized with the canonical current entry's identity, it
    // is provisional for the RemoteNavigable it takes over when the document it populates activates.
