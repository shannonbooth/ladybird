...
{
    image.visit(
        [&source_width, &source_height](GC::Handle<HTMLImageElement> const& source) {
        ...
        [&source_width, &source_height](GC::Handle<SVG::SVGImageElement> const& source) {
        ...
        [&source_width, &source_height](GC::Handle<HTML::HTMLVideoElement> const& source) {
        ...
        [&source_width, &source_height](GC::Handle<HTMLCanvasElement> const& source) {
            if (source->surface()) {
