...
public:
    ...
    GC::Ref<Navigable> remote_navigable() const { return m_remote_navigable; }
...
class RemoteWindowOperationTarget {
public:
    explicit RemoteWindowOperationTarget(String navigable_id)
        : m_navigable_id(move(navigable_id))
    {
    }

    WebIDL::ExceptionOr<void> navigate(JS::VM&, String const& href, Bindings::NavigationHistoryBehavior) const;
    WebIDL::ExceptionOr<void> post_message(Window&, JS::Value message, String const& target_origin, GC::RootVector<GC::Ref<JS::Object>> const&) const;
    WebIDL::ExceptionOr<void> post_message(Window&, JS::Value message, Bindings::WindowPostMessageOptions const&) const;
    void request_window_operation(RemoteWindowOperation) const;

private:
    String m_navigable_id;
};

static Optional<JS::PropertyDescriptor> cross_origin_get_own_property_helper(RemoteLocationObject const&, JS::PropertyKey const&);
static GC::RootVector<JS::Value> cross_origin_own_property_keys_for_properties(Vector<CrossOriginProperty> const&);
...
static GC::Ref<JS::NativeFunction> create_cross_origin_window_method(JS::Realm& realm, GC::Ref<Window> window, String const& property)
{
    ...
    if (property == "postMessage"sv) {
        return JS::NativeFunction::create(
            realm, [window](JS::VM& vm) -> JS::ThrowCompletionOr<JS::Value> {
                ...
                if (vm.argument_count() >= 3) {
                    ...
                    TRY(Bindings::throw_dom_exception_if_needed(vm, [&] { return window->post_message(message, target_origin, transfer); }));
                    return JS::js_undefined();
                }
                ...
                TRY(Bindings::throw_dom_exception_if_needed(vm, [&] { return window->post_message(message, options); }));
                return JS::js_undefined();
            },
...
static GC::Ref<JS::NativeFunction> create_cross_origin_location_method(JS::Realm& realm, GC::Ref<Location> location, String const& property)
{
    if (property == "replace"sv) {
        return JS::NativeFunction::create(
            realm, [location](JS::VM& vm) -> JS::ThrowCompletionOr<JS::Value> {
                ...
                TRY(Bindings::throw_dom_exception_if_needed(vm, [&] { return location->replace(url); }));
                return JS::js_undefined();
            },
...
static GC::Ref<JS::NativeFunction> create_cross_origin_window_setter(JS::Realm& realm, Window& window, String const& property)
{
    if (property == "location"sv) {
        return JS::NativeFunction::create(
            realm, [window = GC::Ref { window }](JS::VM& vm) -> JS::ThrowCompletionOr<JS::Value> {
                auto value = vm.argument(0);
                auto href = TRY(WebIDL::to_usv_string(vm, value));
                auto location = window->location();
                TRY(Bindings::throw_dom_exception_if_needed(vm, [&] { return location->set_href(href); }));
                return JS::js_undefined();
            },
...
static GC::Ref<JS::NativeFunction> create_cross_origin_location_setter(JS::Realm& realm, Location& location, String const& property)
{
    if (property == "href"sv) {
        return JS::NativeFunction::create(
            realm, [location = GC::Ref { location }](JS::VM& vm) -> JS::ThrowCompletionOr<JS::Value> {
...
WebIDL::ExceptionOr<void> RemoteWindowOperationTarget::navigate(JS::VM& vm, String const& href, Bindings::NavigationHistoryBehavior history_handling) const
{
    ...
    source_window.associated_document().page().client().request_navigation_of_remote_child_frame(m_navigable_id, url.release_value(), Empty {}, history_handling);
    return {};
}

WebIDL::ExceptionOr<void> RemoteWindowOperationTarget::post_message(Window& source_window, JS::Value message, String const& target_origin, GC::RootVector<GC::Ref<JS::Object>> const& transfer) const
{
    return source_window.post_message_to_remote_navigable_id(m_navigable_id, message, target_origin, transfer);
}

WebIDL::ExceptionOr<void> RemoteWindowOperationTarget::post_message(Window& source_window, JS::Value message, Bindings::WindowPostMessageOptions const& options) const
{
    return source_window.post_message_to_remote_navigable_id(m_navigable_id, message, options);
}

void RemoteWindowOperationTarget::request_window_operation(RemoteWindowOperation operation) const
{
    auto& source_window = as<Window>(current_global_object());
    source_window.associated_document().page().client().page_did_request_remote_window_operation(m_navigable_id, operation);
}

static GC::Ref<JS::NativeFunction> create_cross_origin_remote_window_method(JS::Realm& realm, RemoteWindowOperationTarget target, String const& property)
{
    if (property == "close"sv) {
        return JS::NativeFunction::create(
            realm, [target = move(target)](JS::VM&) -> JS::ThrowCompletionOr<JS::Value> {
                target.request_window_operation(RemoteWindowOperation::Close);
                return JS::js_undefined();
            },
            0, "close"_utf16_fly_string);
    }
    ...
    if (property == "focus"sv) {
        return JS::NativeFunction::create(
            realm, [target = move(target)](JS::VM&) -> JS::ThrowCompletionOr<JS::Value> {
                target.request_window_operation(RemoteWindowOperation::Focus);
                return JS::js_undefined();
            },
            0, "focus"_utf16_fly_string);
    }
    ...
    if (property == "blur"sv) {
        return JS::NativeFunction::create(
            realm, [target = move(target)](JS::VM&) -> JS::ThrowCompletionOr<JS::Value> {
                target.request_window_operation(RemoteWindowOperation::Blur);
                return JS::js_undefined();
            },
            0, "blur"_utf16_fly_string);
    }
    ...
    if (property == "postMessage"sv) {
        return JS::NativeFunction::create(
            realm, [target = move(target)](JS::VM& vm) -> JS::ThrowCompletionOr<JS::Value> {
                auto message = vm.argument(0);
                auto& source_window = as<Window>(current_global_object());
                ...
                if (vm.argument_count() >= 3) {
                    ...
                    TRY(Bindings::throw_dom_exception_if_needed(vm, [&] {
                        return target.post_message(source_window, message, target_origin, transfer);
                    }));
                    return JS::js_undefined();
                }
                ...
                if (vm.argument_count() >= 2 && !second_argument.is_undefined())
                    options = TRY(Bindings::convert_to_idl_value_for_window_post_message_options(vm, second_argument));
                TRY(Bindings::throw_dom_exception_if_needed(vm, [&] {
                    return target.post_message(source_window, message, options);
                }));
                return JS::js_undefined();
            },
            1, "postMessage"_utf16_fly_string);
...
static GC::Ref<JS::NativeFunction> create_cross_origin_remote_window_getter(JS::Realm& realm, WindowProxy& window_proxy, GC::Ref<Navigable> remote_navigable, String const& property)
{
    ...
    if (property == "closed"sv) {
        return JS::NativeFunction::create(
            realm, [remote_navigable](JS::VM&) -> JS::ThrowCompletionOr<JS::Value> {
                return JS::Value(remote_navigable->is_closed());
            },
            0, "closed"_utf16_fly_string, &realm, "get"sv);
    }
    ...
    if (property == "length"sv) {
        return JS::NativeFunction::create(
            realm, [remote_navigable](JS::VM&) -> JS::ThrowCompletionOr<JS::Value> {
                return JS::Value(remote_navigable->active_document_child_navigable_count());
            },
            0, "length"_utf16_fly_string, &realm, "get"sv);
    }
...
static GC::Ref<JS::NativeFunction> create_cross_origin_remote_window_setter(JS::Realm& realm, RemoteWindowOperationTarget target, String const& property)
{
    if (property == "location"sv) {
        return JS::NativeFunction::create(
            realm, [target = move(target)](JS::VM& vm) -> JS::ThrowCompletionOr<JS::Value> {
                auto href = TRY(WebIDL::to_usv_string(vm, vm.argument(0)));
                TRY(Bindings::throw_dom_exception_if_needed(vm, [&] {
                    return target.navigate(vm, href, Bindings::NavigationHistoryBehavior::Auto);
                }));
                return JS::js_undefined();
            },
            1, "location"_utf16_fly_string, &realm, "set"sv);
...
static GC::Ref<JS::NativeFunction> create_cross_origin_remote_location_method(JS::Realm& realm, RemoteWindowOperationTarget target, String const& property)
{
    if (property == "replace"sv) {
        return JS::NativeFunction::create(
            realm, [target = move(target)](JS::VM& vm) -> JS::ThrowCompletionOr<JS::Value> {
                ...
                auto url = TRY(WebIDL::to_usv_string(vm, vm.argument(0)));
                TRY(Bindings::throw_dom_exception_if_needed(vm, [&] {
                    return target.navigate(vm, url, Bindings::NavigationHistoryBehavior::Replace);
                }));
                return JS::js_undefined();
            },
            1, "replace"_utf16_fly_string);
...
static GC::Ref<JS::NativeFunction> create_cross_origin_remote_location_setter(JS::Realm& realm, RemoteWindowOperationTarget target, String const& property)
{
    if (property == "href"sv) {
        return JS::NativeFunction::create(
            realm, [target = move(target)](JS::VM& vm) -> JS::ThrowCompletionOr<JS::Value> {
...
static GC::Ref<JS::NativeFunction> create_cross_origin_method(JS::Realm& realm, Variant<HTML::Location*, HTML::Window*> const& object, String const& property)
{
    return object.visit(
        [&](HTML::Location* location) { return create_cross_origin_location_method(realm, *location, property); },
        [&](HTML::Window* window) { return create_cross_origin_window_method(realm, *window, property); });
}

static GC::Ref<JS::NativeFunction> create_cross_origin_getter(JS::Realm& realm, Variant<HTML::Location*, HTML::Window*> const& object, String const& property)
{
    return object.visit(
        [&](HTML::Location*) -> GC::Ref<JS::NativeFunction> { VERIFY_NOT_REACHED(); },
        [&](HTML::Window* window) { return create_cross_origin_window_getter(realm, *window, property); });
}

static GC::Ref<JS::NativeFunction> create_cross_origin_setter(JS::Realm& realm, Variant<HTML::Location*, HTML::Window*> const& object, String const& property)
{
    return object.visit(
        [&](HTML::Location* location) { return create_cross_origin_location_setter(realm, *location, property); },
        [&](HTML::Window* window) { return create_cross_origin_window_setter(realm, *window, property); });
}

static Vector<CrossOriginProperty> cross_origin_location_properties()
{
    return {
...
static Vector<CrossOriginProperty> cross_origin_window_properties()
{
    return {
...
Vector<CrossOriginProperty> cross_origin_properties(Variant<HTML::Location const*, HTML::Window const*> const& object)
{
    ...
    return object.visit(
        ...
        [](HTML::Location const*) -> Vector<CrossOriginProperty> {
            return cross_origin_location_properties();
        },
        ...
        [](HTML::Window const*) -> Vector<CrossOriginProperty> {
            return cross_origin_window_properties();
        });
}
...
Optional<JS::PropertyDescriptor> cross_origin_get_own_property_helper(Variant<HTML::Location*, HTML::Window*> const& object, JS::PropertyKey const& property_key)
{
    ...
    for (auto const& entry : cross_origin_properties(object_const_variant)) {
        ...
        if (!entry.needs_get.has_value() && !entry.needs_set.has_value()) {
            ...
            auto value = JS::Value(create_cross_origin_method(realm, object, entry.property).ptr());
        ...
        // 5. Otherwise:
            ...
            if (*entry.needs_get) {
                cross_origin_get = create_cross_origin_getter(realm, object, entry.property).ptr();
            }
            ...
            if (*entry.needs_set) {
                cross_origin_set = create_cross_origin_setter(realm, object, entry.property).ptr();
            }
...
Optional<JS::PropertyDescriptor> cross_origin_get_own_property_helper(WindowProxy const& window_proxy, JS::PropertyKey const& property_key)
{
    ...
    auto cross_origin_key = CrossOriginKey {
        .current_settings_object = (FlatPtr)&HTML::current_settings_object(),
        .relevant_settings_object = (FlatPtr)remote_navigable.ptr(),
        .property_key = property_key,
    };

    auto const& property_key_string = property_key.as_string();
    for (auto const& entry : cross_origin_window_properties()) {
        if (entry.property != property_key_string)
            continue;

        auto& descriptor_map = const_cast<WindowProxy&>(window_proxy).cross_origin_property_descriptor_map();
        auto it = descriptor_map.find(cross_origin_key);
        if (it != descriptor_map.end())
            return it->value;

        auto cross_origin_descriptor = JS::PropertyDescriptor {};
        if (!entry.needs_get.has_value() && !entry.needs_set.has_value()) {
            auto value = JS::Value(create_cross_origin_remote_window_method(realm, RemoteWindowOperationTarget { remote_navigable->id() }, entry.property).ptr());
            cross_origin_descriptor = JS::PropertyDescriptor { .value = value, .writable = false, .enumerable = false, .configurable = true };
        } else {
            Optional<GC::Ptr<JS::FunctionObject>> cross_origin_get;
            if (*entry.needs_get)
                cross_origin_get = create_cross_origin_remote_window_getter(realm, const_cast<WindowProxy&>(window_proxy), *remote_navigable, entry.property).ptr();

            Optional<GC::Ptr<JS::FunctionObject>> cross_origin_set;
            if (*entry.needs_set)
                cross_origin_set = create_cross_origin_remote_window_setter(realm, RemoteWindowOperationTarget { remote_navigable->id() }, entry.property).ptr();

            cross_origin_descriptor = JS::PropertyDescriptor { .get = cross_origin_get, .set = cross_origin_set, .enumerable = false, .configurable = true };
        }

        descriptor_map.set(cross_origin_key, cross_origin_descriptor);
        return cross_origin_descriptor;
    }
...
static Optional<JS::PropertyDescriptor> cross_origin_get_own_property_helper(RemoteLocationObject const& location, JS::PropertyKey const& property_key)
{
    auto& vm = Bindings::main_thread_vm();
    auto& realm = *vm.current_realm();
    ...
    auto cross_origin_key = CrossOriginKey {
        .current_settings_object = (FlatPtr)&HTML::current_settings_object(),
        .relevant_settings_object = (FlatPtr)location.remote_navigable().ptr(),
        .property_key = property_key,
    };

    auto const& property_key_string = property_key.as_string();
    for (auto const& entry : cross_origin_location_properties()) {
        if (entry.property != property_key_string)
            continue;

        auto& descriptor_map = const_cast<RemoteLocationObject&>(location).cross_origin_property_descriptor_map();
        auto it = descriptor_map.find(cross_origin_key);
        if (it != descriptor_map.end())
            return it->value;
        ...
        auto cross_origin_descriptor = JS::PropertyDescriptor {};
        if (!entry.needs_get.has_value() && !entry.needs_set.has_value()) {
            auto value = JS::Value(create_cross_origin_remote_location_method(realm, RemoteWindowOperationTarget { location.remote_navigable()->id() }, entry.property).ptr());
            cross_origin_descriptor = JS::PropertyDescriptor { .value = value, .writable = false, .enumerable = false, .configurable = true };
        } else {
            Optional<GC::Ptr<JS::FunctionObject>> cross_origin_get;
            VERIFY(!*entry.needs_get);

            Optional<GC::Ptr<JS::FunctionObject>> cross_origin_set;
            if (*entry.needs_set)
                cross_origin_set = create_cross_origin_remote_location_setter(realm, RemoteWindowOperationTarget { location.remote_navigable()->id() }, entry.property).ptr();
...
static GC::RootVector<JS::Value> cross_origin_own_property_keys_for_properties(Vector<CrossOriginProperty> const& properties)
{
...
{
    return cross_origin_own_property_keys_for_properties(cross_origin_properties(object));
}

GC::RootVector<JS::Value> cross_origin_own_property_keys(WindowProxy const&)
{
    return cross_origin_own_property_keys_for_properties(cross_origin_window_properties());
}

JS::ThrowCompletionOr<Optional<JS::PropertyDescriptor>> RemoteLocationObject::internal_get_own_property(JS::PropertyKey const& property_key) const
{
    auto descriptor = cross_origin_get_own_property_helper(*this, property_key);
    if (descriptor.has_value())
        return descriptor;
    return TRY(cross_origin_property_fallback(vm(), property_key));
}

JS::ThrowCompletionOr<JS::Value> RemoteLocationObject::internal_get(JS::PropertyKey const& property_key, JS::Value receiver, JS::CacheableGetPropertyMetadata*, PropertyLookupPhase) const
{
    return cross_origin_get(vm(), *this, property_key, receiver);
}

JS::ThrowCompletionOr<bool> RemoteLocationObject::internal_set(JS::PropertyKey const& property_key, JS::Value value, JS::Value receiver, JS::CacheableSetPropertyMetadata*, PropertyLookupPhase)
{
    return cross_origin_set(vm(), *this, property_key, value, receiver);
}

JS::ThrowCompletionOr<GC::RootVector<JS::Value>> RemoteLocationObject::internal_own_property_keys() const
{
    return cross_origin_own_property_keys_for_properties(cross_origin_location_properties());
}

GC::Ref<JS::Object> create_remote_location_object(JS::Realm& realm, GC::Ref<Navigable> remote_navigable)
{
    return RemoteLocationObject::create(realm, remote_navigable);
}
