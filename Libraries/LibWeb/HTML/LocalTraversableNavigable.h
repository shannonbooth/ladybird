...
public:
    ...
    void apply_the_traverse_history_step(int, GC::Ptr<SourceSnapshotParams>, GC::Ptr<LocalNavigable>, UserNavigationInvolvement, GC::Ptr<OnApplyHistoryStepJobsComplete>, GC::Ref<GC::Function<void(HistoryStepResult)>> on_complete);
    ...
    void traverse_the_history_to_step(int step, GC::Ref<OnApplyHistoryStepJobsComplete> on_jobs_complete, GC::Ref<GC::Function<void(bool step_was_available, HistoryStepResult)>> on_complete);
