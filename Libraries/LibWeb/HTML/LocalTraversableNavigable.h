...
public:
    ...
    void request_history_operation(HistoryOperationRequest);
    void request_history_operation(HistoryOperationRequest, HistoryOperationState);
    ...
    void append_finalize_a_same_document_navigation_steps(GC::Ref<LocalNavigable>, NonnullRefPtr<SessionHistoryEntry>, RefPtr<SessionHistoryEntry> entry_to_replace, HistoryHandlingBehavior, UserNavigationInvolvement, Optional<SessionHistoryEntryPersistedState> previous_entry_persisted_state);
