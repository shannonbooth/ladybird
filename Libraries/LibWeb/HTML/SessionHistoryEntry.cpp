...
SameDocumentNavigationEntry create_same_document_navigation_entry(SessionHistoryEntry const& entry, SessionHistoryEntryDescriptorCreationState& creation_state)
{
    auto document_state = entry.document_state();
    VERIFY(document_state);
    return {
        .url = entry.url(),
        .document_state_id = document_state_id_for_descriptor(*document_state, creation_state),
        .classic_history_api_state = entry.classic_history_api_state(),
        .navigation_api_state = entry.navigation_api_state(),
        .navigation_api_key = entry.navigation_api_key(),
        .navigation_api_id = entry.navigation_api_id(),
