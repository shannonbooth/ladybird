...
public:
    ...
    Vector<GC::Handle<IDBDatabase>> associated_connections_except(IDBDatabase& connection)
    {
        Vector<GC::Handle<IDBDatabase>> connections;
    ...
    [[nodiscard]] static Optional<GC::Handle<Database>> for_key_and_name(StorageAPI::StorageKey&, String&);
    [[nodiscard]] static ErrorOr<GC::Handle<Database>> create_for_key_and_name(JS::Realm&, StorageAPI::StorageKey&, String&);
