...
void EventLoopPluginSerenity::spin_until(GC::Handle<GC::Function<bool()>> goal_condition)
{
...
void EventLoopPluginSerenity::deferred_invoke(GC::Handle<GC::Function<void()>> function)
{
    VERIFY(function);
