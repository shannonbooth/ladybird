...
PatternErrorOr<String> canonicalize_an_opaque_pathname(String const& value)
{
    ...
    // FIXME: Update the URL parser state name 'cannot be a base url' to 'opaque' state.
    auto parse_result = Parser::basic_parse(value, {}, &dummy_url, Parser::State::CannotBeABaseUrlPath);
