...
use crate::pattern::{
    EncodingCallback, ErrorInfo, Options, Part, PatternErrorOr, PatternParser,
    escape_a_regexp_string, full_wildcard_regexp_value, generate_a_pattern_string,
...
fn generate_a_regular_expression_and_name_list(
    ...
    for part in part_list {
        ...
        assert!(
            part.modifier == PartModifier::ZeroOrMore || part.modifier == PartModifier::OneOrMore
        );
