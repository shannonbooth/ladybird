...
use libtextcodec_rust::{EncodeItem, encode_into as textcodec_encode_into, get_output_encoding};
...
pub(super) fn output_encoding(encoding: &str) -> String {
...
pub(super) fn append_percent_encoded_if_necessary(
    buffer: &mut String,
    code_point: char,
    set: PercentEncodeSet,
) {
