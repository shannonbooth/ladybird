...
enum class WebContentHistoryStepStatus : u8 {
    IgnoredStale,
    FallbackLoad,
    Unavailable,
    Canceled,
...
struct WebContentHistoryStepResult {
    WebContentHistoryStepStatus status { WebContentHistoryStepStatus::IgnoredStale };
    ...
    bool pending_step_was_available { false };
};

enum class HistoryStepCancelationCheckStatus : u8 {
    IgnoredStale,
    Canceled,
    NoTarget,
    LoadTarget,
...
struct HistoryStepCancelationCheckResult {
    HistoryStepCancelationCheckStatus status { HistoryStepCancelationCheckStatus::IgnoredStale };
    Function<void(HistoryTraversalOutcome)> on_cancelation_check_complete;
    HistoryTraversalOutcome outcome;
...
enum class WebContentSessionHistoryUpdateStatus : u8 {
    IgnoredBeforeSeedAck,
    IgnoredPartialBeforeFallbackSeed,
    IgnoredBeforeSeed,
    IgnoredRejectedSeedSnapshotForTesting,
    Updated,
};

struct WebContentSessionHistoryUpdateDecision {
    WebContentSessionHistoryUpdateStatus status { WebContentSessionHistoryUpdateStatus::Updated };
