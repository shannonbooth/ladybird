...
public:
    ...
    CanonicalBrowsingContext& browsing_context_for_document_creation(WebContentPageHandle const&) const;
    ...
    void check_if_unloading_is_canceled(Vector<Web::HTML::CrossProcessId> navigable_ids, Optional<WebContentPageHandle> skipped_endpoint, Web::HTML::UnloadPromptShown, Function<void(Web::HTML::HistoryStepResult, Web::HTML::UnloadPromptShown)> on_complete);
    void did_receive_changing_navigable_history_job_ready(WebContentPageHandle const& source_page, Web::HTML::CrossProcessId operation_id, Web::HTML::CrossProcessId navigable_id, Web::HTML::ChangingNavigableHistoryStepJobDisposition, Web::HTML::UnloadDisplayedDocument);
    void did_finish_history_navigation_params_creation(WebContentPageHandle const& source_page, Web::HTML::CrossProcessId operation_id, Web::HTML::HistoryNavigationPopulation);
    void did_receive_changing_navigable_unload_preparation_complete(WebContentPageHandle const& source_page, Web::HTML::CrossProcessId operation_id, Web::HTML::CrossProcessId navigable_id);
    void did_receive_descendant_unload_task_complete(WebContentPageHandle const& source_page, Web::HTML::CrossProcessId unload_id, Web::HTML::CrossProcessId navigable_id);
    void did_receive_child_navigable_unload_request(WebContentPageHandle const& source_page, Web::HTML::CrossProcessId navigable_id);
    void did_receive_changing_navigable_continuation_applied(WebContentPageHandle const& source_page, Web::HTML::CrossProcessId operation_id, Web::HTML::CrossProcessId navigable_id, Optional<Web::HTML::ReplicatedNavigableState> activated_navigable_state, Optional<Web::HTML::SessionHistoryEntryPersistedState> previous_entry_persisted_state);
    void did_receive_nonchanging_navigable_history_state_updated(WebContentPageHandle const& source_page, Web::HTML::CrossProcessId operation_id, Web::HTML::CrossProcessId navigable_id);

    CanonicalNavigable& insert(WebContentPageHandle reporting_page, Web::HTML::CrossProcessId parent_frame_id, Web::HTML::CrossProcessId frame_id, Web::HTML::ReplicatedNavigableState, NonnullRefPtr<CanonicalBrowsingContext>, CanonicalNavigable& fallback_parent);
    ...
    void for_each_hosting_page(Function<void(WebContentPageHandle const&)> const&) const;
    ...
    bool is_opener_page(WebContentPageHandle const& page) const { return m_opener_pages.contains_slow(page); }
    ...
    void set_has_system_focus(bool, Optional<WebContentPageHandle> requesting_page);
    ...
    void recover_from_web_content_process_crash(Optional<WebContentPageHandle> crashed_endpoint, OnHistoryOperationComplete);
...
private:
    ...
    bool navigation_transaction_matches(HistoryOperation const&, WebContentPageHandle const&, Optional<Web::HTML::CrossProcessId> reply_navigable_id = {}) const;
    ...
    void add_history_operation_completion_endpoint(HistoryOperation&, WebContentPageHandle);
    ...
    void did_activate_history_entry(HistoryOperation&, Web::HTML::CrossProcessId navigable_id, WebContentPageHandle source_page, Web::HTML::SessionHistoryEntryDescriptor const& target_entry, CanonicalNavigable::DidPopulateDocument, RefPtr<CanonicalBrowsingContext> destination_browsing_context, Web::HTML::ReplicatedNavigableState activated_navigable_state);
    ...
    void dispatch_crash_recovery_changing_job(HistoryOperation&, WebContentPageHandle, Web::HTML::HistoryObjectLengthAndIndex, Function<void()> on_complete);
    ...
    Optional<WebContentPageHandle> m_displaced_document_host;

    // Pages that hold this tab, and host none of it, in a process holding part of a tab this tab opened.
    Vector<WebContentPageHandle> m_opener_pages;
    ...
    struct PendingBeforeunloadCheck {
        ...
        Optional<WebContentPageHandle> dispatched_endpoint;
