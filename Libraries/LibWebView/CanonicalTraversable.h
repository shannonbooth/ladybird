...
public:
    ...
    WebContentSessionHistorySeedAckResult did_receive_web_content_session_history_seed_ack(bool accepted, i32 current_step, TraversableSessionHistory::SeedAckProof);
