...
public:
    ...
    void create_new_process_for_cross_site_navigation(Web::HTML::PendingSessionHistoryEntryDescriptor, Optional<Web::HTML::NavigationSourceSnapshot>, Web::HTML::SandboxingFlagSet target_sandboxing_flags, Web::ReferrerPolicy::ReferrerPolicy iframe_element_referrer_policy, Web::ContentSecurityPolicy::Directives::Directive::NavigationType, Web::Bindings::NavigationHistoryBehavior, Web::HTML::UserNavigationInvolvement, Utf16String navigation_id);
...
protected:
    ...
    // WebDriver's observation of the top-level navigation arc. The navigation itself is the
