...
public:
    ...
    void did_apply_top_level_same_document_session_history_navigation(Badge<WebContentClient>, Web::HTML::SessionHistoryEntryDescriptor, Optional<i32> replaced_step, i32 current_step);
