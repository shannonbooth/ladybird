...
static void fail_webdriver_content_commands_after_process_replacement(HashMap<u64, WebContentPageHandle> const& commands)
{
...
static void fail_webdriver_content_commands_after_window_close(HashMap<u64, WebContentPageHandle> const& commands)
{
    for (auto const& command : commands)
...
void ViewImplementation::handle_external_url(Badge<WebContentPageHandle>, URL::URL url, URL::Origin initiator_origin, bool has_transient_activation)
{
...
void ViewImplementation::did_finish_handling_input_event(Badge<WebContentPageHandle>, u64 event_id, Web::EventResult event_result)
{
...
void ViewImplementation::did_lose_input_event_endpoint(Badge<WebContentClient>, WebContentPageHandle const& page)
{
...
void ViewImplementation::set_preferred_color_scheme(Web::CSS::PreferredColorScheme color_scheme)
{
    ...
    m_top_level_traversable.for_each_hosting_page([&](WebContentPageHandle const& page) {
...
static void send_browsing_behavior(WebContentPageHandle const& page)
{
    page.async_set_browsing_behavior(Application::settings().browsing_behavior());
}

static void send_autoplay_settings(WebContentPageHandle const& page)
{
...
static void send_global_privacy_control(WebContentPageHandle const& page)
{
    page.async_set_enable_global_privacy_control(Application::settings().global_privacy_control() == GlobalPrivacyControl::Yes);
}

void ViewImplementation::send_preferences_to_page(Badge<WebContentClient>, WebContentPageHandle const& page)
{
...
ErrorOr<Core::SharedVersionIndex> ViewImplementation::ensure_document_cookie_version_index(Badge<WebContentPageHandle>, String const& domain)
{
...
void ViewImplementation::did_receive_selected_text(Badge<WebContentPageHandle>, u64 request_id, ByteString selection)
{
...
void ViewImplementation::did_cut_selected_text(Badge<WebContentPageHandle>, u64 request_id, ByteString selection)
{
...
void ViewImplementation::did_receive_selected_text_for_lookup(Badge<WebContentPageHandle>, u64 request_id, Optional<DictionaryLookup> lookup)
{
...
void ViewImplementation::did_select_word_for_dictionary_lookup(Badge<WebContentPageHandle>, u64 request_id, bool selected)
{
...
void ViewImplementation::did_pause_debugger(Badge<WebContentPageHandle>)
{
    set_debugger_paused(true);
}

void ViewImplementation::did_resume_debugger(Badge<WebContentPageHandle>)
{
...
void ViewImplementation::did_request_cursor_change(Badge<WebContentPageHandle>, Gfx::Cursor cursor)
{
...
static bool another_page_awaits(Optional<WebContentPageHandle> const& owner, WebContentPageHandle const& requesting_page)
{
    return owner.has_value() && owner->is_open() && *owner != requesting_page;
}

void ViewImplementation::did_request_color_picker(Badge<WebContentPageHandle>, WebContentPageHandle const& requesting_page, Color current_color)
{
...
void ViewImplementation::did_request_file_picker(Badge<WebContentPageHandle>, WebContentPageHandle const& requesting_page, Web::HTML::FileFilter const& accepted_file_types, Web::HTML::AllowMultipleFiles allow_multiple_files)
{
...
void ViewImplementation::did_request_select_dropdown(Badge<WebContentClient>, WebContentPageHandle const& requesting_page, Gfx::IntPoint content_position, i32 minimum_width, Vector<Web::HTML::SelectItem> items)
{
...
void ViewImplementation::set_input_method_state(Badge<WebContentPageHandle>, InputMethodState state)
{
...
void ViewImplementation::did_change_audio_play_state(Badge<WebContentPageHandle>, Web::HTML::AudioPlayState play_state)
{
...
void ViewImplementation::did_change_screen_wake_lock_state(Badge<WebContentPageHandle>, Web::ScreenWakeLockState wake_lock_state)
{
...
void ViewImplementation::did_change_background_color(Badge<WebContentPageHandle>, Gfx::Color color)
{
...
void ViewImplementation::initialize_client(CreateNewClient create_new_client, Optional<Web::HTML::CrossProcessId> initial_document_state_id)
{
    ...
    auto make_geolocation_success_handler = [this](WebContentPageHandle const& request_page, u64 request_id, bool is_watch) {
        auto weak_this = make_weak_ptr();
    ...
    auto make_geolocation_error_handler = [this, geolocation_error_code](WebContentPageHandle const& request_page, u64 request_id, bool is_watch) {
        auto weak_this = make_weak_ptr();
        auto key = GeolocationRequestKey { request_page, request_id };
    ...
    on_request_geolocation_position = [this, geolocation_error_code, make_geolocation_success_handler, make_geolocation_error_handler](WebContentPageHandle const& requesting_page, u64 request_id) {
        if (!Application::settings().geolocation_enabled()) {
    ...
    on_cancel_geolocation_position_request = [this](WebContentPageHandle const& requesting_page, u64 request_id) {
    ...
    on_start_geolocation_position_watch = [this, geolocation_error_code, make_geolocation_success_handler, make_geolocation_error_handler](WebContentPageHandle const& requesting_page, u64 request_id) {
        if (!Application::settings().geolocation_enabled()) {
            requesting_page.async_geolocation_position_response(request_id, {}, to_underlying(GeolocationErrorCode::PermissionDenied));
            return;
        }
    ...
    on_stop_geolocation_position_watch = [this](WebContentPageHandle const& requesting_page, u64 request_id) {
...
void ViewImplementation::did_lose_page(Badge<CanonicalTraversable>, WebContentPageHandle const& page)
{
    ...
    m_pending_webdriver_commands.remove_all_matching([&](u64 command_id, WebContentPageHandle const& command_page) {
...
void ViewImplementation::did_set_webdriver_current_browsing_context(Badge<WebContentPageHandle>, u64 command_id, Web::HTML::CrossProcessId navigable_id)
{
...
void ViewImplementation::did_complete_webdriver_content_command(Badge<WebContentPageHandle>, u64 command_id, Web::WebDriver::Response response)
{
...
void ViewImplementation::did_complete_webdriver_user_prompt_handling(Badge<WebContentPageHandle>, u64 request_id, Web::WebDriver::Response response)
{
...
void ViewImplementation::recover_current_session_history_entry_with_history_operation(Optional<WebContentPageHandle> crashed_endpoint)
{
    m_history_visit_transition_for_next_load = HistoryVisitTransition::Restore;
    auto const* current_entry = m_top_level_traversable.session_history().current_entry();
...
void ViewImplementation::request_history_operation(Badge<WebContentPageHandle>, WebContentPageHandle const& requesting_page, Web::HTML::CrossProcessId operation_id, Web::HistoryOperationParameters parameters)
{
...
void ViewImplementation::send_geolocation_emulated_position(WebContentPageHandle const& page)
{
    using ErrorCode = Web::Geolocation::GeolocationPositionError::ErrorCode;
...
void ViewImplementation::did_receive_screenshot(Badge<WebContentPageHandle>, Gfx::ShareableBitmap const& screenshot)
{
...
void ViewImplementation::did_receive_internal_page_info(Badge<WebContentPageHandle>, PageInfoType, Optional<Core::AnonymousBuffer> const& info)
{
...
void ViewImplementation::did_request_media_context_menu(Badge<WebContentClient>, WebContentPageHandle const& requesting_page, Gfx::IntPoint content_position, Web::Page::MediaContextMenu menu)
{
