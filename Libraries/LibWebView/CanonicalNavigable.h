...
public:
    ...
    // Canonical record of this navigable's in-flight navigation. This is the UI-process home
    // of the specification's ongoing navigation slot. It also records where the pending
    ...
    bool navigation_transaction_matches(Optional<Utf16String> const&, WebContentClient const&, u64 page_id) const;
