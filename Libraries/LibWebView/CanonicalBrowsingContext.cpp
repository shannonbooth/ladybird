...
CanonicalBrowsingContext::BrowsingContextAndDocument CanonicalBrowsingContext::create_a_new_auxiliary_browsing_context_and_document(CanonicalNavigable& opener, URL::Origin const& document_origin, Optional<WebContentPage&> document_page)
{
    ...
    browsing_context_and_document.browsing_context->set_opener_browsing_context(opener.active_browsing_context());
...
RefPtr<CanonicalDocument> CanonicalBrowsingContext::active_document() const
{
...
{
    m_opener_browsing_context = opener ? opener->make_weak_ptr<CanonicalBrowsingContext>() : WeakPtr<CanonicalBrowsingContext> {};
}
