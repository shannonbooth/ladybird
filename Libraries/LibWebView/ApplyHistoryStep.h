...
struct WEBVIEW_API ApplyHistoryStepJobs {
    ...
    struct UnloadCancelationJob {
        NonnullRefPtr<CanonicalSessionHistoryEntry const> target_entry;
...
private:
    ...
    CanonicalSessionHistoryEntry const* append_the_claimed_target_entry_again(CanonicalNavigable&, CanonicalSessionHistoryEntry const& claimed_target_entry);
    ...
    HashMap<Web::HTML::CrossProcessId, NonnullRefPtr<CanonicalSessionHistoryEntry const>> m_claimed_target_entries;
