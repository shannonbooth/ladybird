...
public:
    ...
    // NB: Not the id, nor the document, which is the active or populated document of a navigable. Nested histories
    //     are copied as lists of the same entries.
    void copy_values_from(CanonicalDocumentState const&);
