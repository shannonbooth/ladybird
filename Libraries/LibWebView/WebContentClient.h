...
private:
    ...
    virtual void request_history_traversal(u64 page_id, u64 initiation_id, Web::HistoryTraversalRequestType, i32 delta_or_step, Web::HTML::CrossProcessId navigable_id, Utf16String navigation_api_key, Web::HTML::UserNavigationInvolvement) override;
    virtual void history_step_cancelation_job_result(u64 page_id, u64 operation_id, Web::HTML::HistoryStepResult) override;
    virtual void changing_navigable_history_job_ready(u64 page_id, u64 operation_id, Web::HTML::CrossProcessId navigable_id, Web::ChangingNavigableHistoryStepJobDisposition) override;
