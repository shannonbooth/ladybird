...
private:
    ...
    virtual void did_start_loading(u64 page_id, Optional<String>, URL::URL, Variant<Empty, String, Web::HTML::POSTResource>, Web::HTML::CrossProcessId, bool, Web::Bindings::NavigationHistoryBehavior) override;
    ...
    virtual Messages::WebContentClient::DidRequestTraverseTheHistoryByDeltaResponse did_request_traverse_the_history_by_delta(u64 page_id, Optional<u64> history_traversal_request_id, Web::HTML::SessionHistoryOperationId last_session_history_mutation_id, i32 delta) override;
    ...
    virtual void did_install_top_level_session_history_state(u64 page_id, u64 state_install_id, bool accepted, i32 current_step) override;
