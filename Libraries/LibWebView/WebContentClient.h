...
private:
    ...
    virtual void did_start_loading(u64 page_id, URL::URL, Variant<Empty, String, Web::HTML::POSTResource>, Web::HTML::CrossProcessId, bool, Web::Bindings::NavigationHistoryBehavior) override;
