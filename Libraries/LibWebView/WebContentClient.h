...
private:
    ...
    virtual void did_request_navigation_of_navigable(u64 page_id, Web::HTML::CrossProcessId navigable_id, Web::HTML::PreparedNavigationDescriptor) override;
    virtual void did_post_message_to_navigable(u64 page_id, Web::HTML::CrossProcessId navigable_id, Web::HTML::PostedMessageDescriptor) override;
    ...
    virtual void did_change_replicated_navigable_state(u64 page_id, Web::HTML::CrossProcessId navigable_id, Web::HTML::ReplicatedNavigableState) override;
    ...
    virtual void did_set_site_compatibility_data_for_testing(u64 page_id, JsonValue data) override;
    virtual void did_set_experimental_interfaces_exposed_for_testing(u64 page_id, bool exposed) override;
