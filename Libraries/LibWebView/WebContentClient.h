...
private:
    ...
    virtual void did_report_session_history_update(u64 page_id, Web::HTML::WebContentSessionHistoryUpdate) override;
    ...
    virtual void did_set_top_level_session_history(u64 page_id, u64 seed_id, bool accepted) override;
