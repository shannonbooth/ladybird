...
private:
    ...
    virtual void did_request_navigation_hosting(u64 page_id, Web::HTML::CrossProcessId navigable_id, URL::URL current_url, URL::URL target_url, Web::NavigationTarget target, Web::HTML::DocumentResource document_resource, Web::Bindings::NavigationHistoryBehavior history_handling, Optional<Web::HTML::NavigationSourceSnapshot> source_snapshot, Utf16String navigation_id) override;
