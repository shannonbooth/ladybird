...
public:
    ...
    Optional<RemoteChildFrameInputTarget> remote_child_frame_input_target_at(WebContentPageHandle const&, CanonicalNavigable const& root, Web::DevicePixelPoint) const;
