...
public:
    ...
    bool has_matching_pending_child_frame_navigation(u64 page_id, StringView frame_id, URL::URL const&, CanonicalNavigable::PendingNavigationHost) const;
    void record_pending_child_frame_navigation(u64 page_id, StringView frame_id, URL::URL const&, CanonicalNavigable::PendingNavigationHost);
    ...
    Optional<CanonicalNavigable&> child_navigable(u64 page_id, StringView frame_id);
    Optional<CanonicalNavigable const&> child_navigable(u64 page_id, StringView frame_id) const;
...
private:
    ...
    struct ParentFrame {
        ...
        u64 page_id { 0 };
        String frame_id;
        CanonicalNavigable* child_navigable { nullptr };
    };

    static bool client_owns_page(WebContentClient const&, u64 page_id);
    Optional<CanonicalTraversable&> canonical_traversable_for_page(WebContentClient&, u64 page_id);
    Optional<CanonicalTraversable const&> canonical_traversable_for_page(WebContentClient const&, u64 page_id) const;
    Optional<CanonicalTraversable&> canonical_traversable_for_page(u64 page_id);
    Optional<CanonicalTraversable const&> canonical_traversable_for_page(u64 page_id) const;
    ...
    HashMap<u64, CanonicalTraversable*> m_page_traversables;
};
