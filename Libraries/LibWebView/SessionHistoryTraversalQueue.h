...
//
// AD-HOC: The specification runs the queue on a parallel queue that loops forever. This one is driven by the UI
//         process event loop instead, and because steps can span IPC they signal completion through a promise rather
//         than by returning.
