...
struct TestTraversable {
    ...
    {
        return traversable.append_child(make<WebView::CanonicalNavigable>(id, traversable.id(), WebView::WebContentPageHandle {}));
    }
...
{
    WebView::CanonicalNavigable navigable(root_id(), {}, WebView::WebContentPageHandle {});
