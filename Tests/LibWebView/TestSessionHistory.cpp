...
static Web::HTML::SameDocumentSessionHistoryEntryDescriptor same_document_entry(Web::HTML::SessionHistoryEntryDescriptor entry)
{
    return {
        .url = move(entry.url),
...
static HistoryOperationResult run_canonical_history_operation(WebView::CanonicalTraversable& traversable, Web::HistoryOperationRequest request)
{
...
TEST_CASE(same_document_push_clears_forward_history_at_queue_position)
{
    ...
    auto request = Web::FinalizeSameDocumentNavigationRequest {
