...
ErrorOr<int> ladybird_main(Main::Arguments arguments)
{
    ...
    restored_view->switch_process_for_history_traversal(restored_view->traversable().session_history().current_entry()->document_state.id, WebView::ViewImplementation::KeepsBrowsingContext::Yes);
