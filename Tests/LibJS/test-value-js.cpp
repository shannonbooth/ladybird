...
#define EXPECT_TO_BE_NAN(input)                \
    ...
    EXPECT_TO_BE_NAN(GC::CANON_NAN_BITS | (NULL_TAG << TAG_SHIFT));
    EXPECT_TO_BE_NAN(GC::CANON_NAN_BITS | (UNDEFINED_TAG << TAG_SHIFT));
    EXPECT_TO_BE_NAN(GC::CANON_NAN_BITS | (INT32_TAG << TAG_SHIFT) | 0x88);
    EXPECT_TO_BE_NAN(GC::CANON_NAN_BITS | (OBJECT_TAG << TAG_SHIFT));
    EXPECT_TO_BE_NAN(GC::CANON_NAN_BITS | (OBJECT_TAG << TAG_SHIFT) | 0x1230);
    EXPECT_TO_BE_NAN(GC::CANON_NAN_BITS | (STRING_TAG << TAG_SHIFT));
    EXPECT_TO_BE_NAN(GC::CANON_NAN_BITS | (STRING_TAG << TAG_SHIFT) | 0x1230);

    u64 sign_bit = 1ULL << 63;

    EXPECT_TO_BE_NAN(GC::CANON_NAN_BITS | sign_bit | 0x1);
    EXPECT_TO_BE_NAN(GC::CANON_NAN_BITS | sign_bit | 0x10);
    EXPECT_TO_BE_NAN(GC::CANON_NAN_BITS | sign_bit | (NULL_TAG << TAG_SHIFT));
    EXPECT_TO_BE_NAN(GC::CANON_NAN_BITS | sign_bit | (UNDEFINED_TAG << TAG_SHIFT));
    EXPECT_TO_BE_NAN(GC::CANON_NAN_BITS | sign_bit | (INT32_TAG << TAG_SHIFT) | 0x88);
    EXPECT_TO_BE_NAN(GC::CANON_NAN_BITS | sign_bit | (OBJECT_TAG << TAG_SHIFT));
    EXPECT_TO_BE_NAN(GC::CANON_NAN_BITS | sign_bit | (OBJECT_TAG << TAG_SHIFT) | 0x1230);
    EXPECT_TO_BE_NAN(GC::CANON_NAN_BITS | sign_bit | (STRING_TAG << TAG_SHIFT));
    EXPECT_TO_BE_NAN(GC::CANON_NAN_BITS | sign_bit | (STRING_TAG << TAG_SHIFT) | 0x1230);
